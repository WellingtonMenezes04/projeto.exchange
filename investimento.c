...
int validar_senha() {
  ...
  scanf("%s", senha);
  return strcmp(usuario.senha, senha) ==
         0; // retorna 1 se a senha estiver correta e 0 caso contrario
}
...
void comprar_criptomoeda() {
  ...
  printf("Confirma a compra de %.2f %s com taxa de %.2f%% (valor total: %.2f)? "
         "(s/n): ",
         valor, cripto, taxa * 100, valor_total);
  char confirmacao;
  scanf(" %c", &confirmacao);
...
void vender_criptomoeda() {
  ...
  double valor_reais =
      valor * cotacao * (1 - taxa); // valor final em reais apos aplicar a taxa

  printf("Confirma a venda de %.2f %s com taxa de %.2f%% (valor total: %.2f)? "
         "(s/n): ",
         valor, cripto, taxa * 100, valor_reais);
  char confirmacao;
  scanf(" %c", &confirmacao);
